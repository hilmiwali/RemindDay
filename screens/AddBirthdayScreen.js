// screens/AddBirthdayScreen.js
// This screen allows users to add new birthdays
...
const AddBirthdayScreen = ({ navigation }) => {
  ...
  const saveBirthday = async () => {
    ...
    try {
      ...
      // Create birthday object for notification
      const newBirthday = {
        id: birthdayId,
        name: name.trim(),
      ...
      Alert.alert(
        'Success!', 
        `Birthday reminder for ${name} has been saved and notification scheduled!`,
        [
          {
            text: 'OK',
